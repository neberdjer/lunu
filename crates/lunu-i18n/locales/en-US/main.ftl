...
error-oidc-state-invalid = That sign-on attempt is unknown or expired. Start again.
...
error-mfa-required = Two-factor authentication is required to finish signing in.
