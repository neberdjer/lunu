...
pub fn configure(cfg: &mut ServiceConfig) {
	cfg.service(health::health)
		...
		.service(auth::mfa::enroll)
		.service(auth::mfa::confirm)
		.service(auth::mfa::regenerate_recovery_codes)
		.service(auth::mfa::disable)
		.service(auth::mfa::admin_reset)
		.service(auth::oidc::start)
		.service(auth::oidc::callback)
		.service(auth::logout)
		...
		.service(library::merge)
		.service(library::merge_all)
		.service(library::revert)
		.service(library::merge_preview)
